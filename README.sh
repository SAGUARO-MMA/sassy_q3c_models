...
python3 -c "import sassy_q3c_models.ls_dr10_q3c_orm;         print(sassy_q3c_models.ls_dr10_q3c_orm.__doc__)"
...
python3 -c "import sassy_q3c_models.roma_bzcat_q3c_orm;      print(sassy_q3c_models.roma_bzcat_q3c_orm.__doc__)"
...
python3 sassy_q3c_models/desi_spec_q3c_orm_cli.py       --help
python3 sassy_q3c_models/fermi_lat_q3c_orm_cli.py       --help
...
python3 sassy_q3c_models/ls_dr10s_q3c_orm_cli.py        --help
python3 sassy_q3c_models/non_detections_orm_cli.py      --help
python3 sassy_q3c_models/ps1_q3c_orm_cli.py             --help
python3 sassy_q3c_models/roma_bzcat_q3c_orm_cli.py       --help
