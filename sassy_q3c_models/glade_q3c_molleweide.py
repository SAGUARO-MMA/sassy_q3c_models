...
# __doc__
# -
__doc__ = """ python3 glade_q3c_molleweide.py --help """


# +
# function: glade_q3c_molleweide()
# -
def glade_q3c_molleweide(_verbose: bool = False):
    ...
    try:
        ax.scatter(np.radians(_ra_np), np.radians(_dec_np), color='blue', s=2.5,
                   alpha=0.25, marker='D', label="GLADE")
    ...
    # output(s)
    _png = os.path.abspath(os.path.expanduser(f"glade_q3c_molleweide.png"))
...
if __name__ == '__main__':
    ...
    # execute
    try:
        glade_q3c_molleweide(_verbose=bool(_a.verbose))
