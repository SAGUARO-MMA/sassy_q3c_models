...
class RomaBzcatQ3cRecord(db.Model):
    ...
    z_err = db.Column(db.Float, nullable=False)
    ...
    flux_143 = db.Column(db.Float, nullable=False)
    flux_xray = db.Column(db.Float, nullable=False)
    flux_fermi = db.Column(db.Float, nullable=False)
    aro = db.Column(db.Float, nullable=False)
