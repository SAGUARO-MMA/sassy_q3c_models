...
class Sdss12PhotoZQ3cRecord(db.Model):
    ...
    u_prime_mag = db.Column(db.Float, nullable=False)
    e_u_prime_mag = db.Column(db.Float, nullable=False)
    u_pmag = db.Column(db.Float, nullable=False)
    e_u_pmag = db.Column(db.Float, nullable=False)
    u_upmag = db.Column(db.Float, nullable=False)
    ...
    g_prime_mag = db.Column(db.Float, nullable=False)

    # 60: ["e_g'mag", 'gpmag', 'e_gpmag', 'gPmag', 'e_gPmag', 'gPrad', 'e_gPrad', 'goRA', 'goDE', 'gdVrad']
    e_g_prime_mag = db.Column(db.Float, nullable=False)
    g_pmag = db.Column(db.Float, nullable=False)
    e_g_pmag = db.Column(db.Float, nullable=False)
    g_upmag = db.Column(db.Float, nullable=False)
    ...
    r_prime_mag = db.Column(db.Float, nullable=False)
    e_r_prime_mag = db.Column(db.Float, nullable=False)
    r_pmag = db.Column(db.Float, nullable=False)
    e_r_pmag = db.Column(db.Float, nullable=False)

    # 80: ['rPmag', 'e_rPmag', 'rPrad', 'e_rPrad', 'roRA', 'roDE', 'rdVrad', 'rdVell', 'rPA', 'iFlags']
    r_upmag = db.Column(db.Float, nullable=False)
    ...
    i_prime_mag = db.Column(db.Float, nullable=False)
    e_i_prime_mag = db.Column(db.Float, nullable=False)
    i_pmag = db.Column(db.Float, nullable=False)
    e_i_pmag = db.Column(db.Float, nullable=False)
    i_upmag = db.Column(db.Float, nullable=False)
    ...
    # 110: ["z'mag", "e_z'mag", 'zpmag', 'e_zpmag', 'zPmag', 'e_zPmag', 'zPrad', 'e_zPrad', 'zoRA', 'zoDE']
    z_prime_mag = db.Column(db.Float, nullable=False)
    e_z_prime_mag = db.Column(db.Float, nullable=False)
    z_pmag = db.Column(db.Float, nullable=False)
    e_z_pmag = db.Column(db.Float, nullable=False)
    z_upmag = db.Column(db.Float, nullable=False)
    ...
    # 140: ['absMagU', 'absMagG', 'absMagR', 'absMagI', 'absMagZ']
    abs_u_mag = db.Column(db.Float, nullable=False)
    abs_g_mag = db.Column(db.Float, nullable=False)
    abs_r_mag = db.Column(db.Float, nullable=False)
    abs_i_mag = db.Column(db.Float, nullable=False)
    abs_z_mag = db.Column(db.Float, nullable=False)
