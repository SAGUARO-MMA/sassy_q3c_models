...
class GaiaDR3VariableQ3cRecord(db.Model):
    ...
    best_class_name = db.Column(db.String(DB_VARCHAR_32), nullable=False, default='', index=True)
    best_class_score = db.Column(db.Float, nullable=False, index=True)
    num_selected_g_fov = db.Column(db.Integer, nullable=False)
    ...
    num_selected_bp = db.Column(db.Integer, nullable=False)
    ...
    num_selected_rp = db.Column(db.Integer, nullable=False)
