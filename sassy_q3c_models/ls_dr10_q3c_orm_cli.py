...
if __name__ == '__main__':
    ...
    _p.add_argument(f'--w1_flux__lte', help=f'W1 flux <= <float>')
    _p.add_argument(f'--w2_flux__gte', help=f'W2 flux >= <float>')
    _p.add_argument(f'--w2_flux__lte', help=f'W2 flux <= <float>')
    _p.add_argument(f'--w3_flux__gte', help=f'W3 flux >= <float>')
    _p.add_argument(f'--w3_flux__lte', help=f'W3 flux <= <float>')
